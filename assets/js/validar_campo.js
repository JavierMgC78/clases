//CATALOGO DE ESTADOS
function estados(){
    return ['valueMissing', 'typeMismatch', 'patternMismatch', 'customError', 'badInput'];
}
...
function msg(typeValid, elemento){
    let states =  [
        ...
        {tipo: 'float',     valid: 'valueMissing',    msg: 'Debe introducir un monto'},
        {tipo: 'float',     valid: 'badInput',        msg: 'Solo puede contener numeros. El seprador decimal es punto (.)'},
...
function validar(elemento){
    ...
    //console.log(elemento.validity);
    //console.log(elemento.dataset.tipo);
